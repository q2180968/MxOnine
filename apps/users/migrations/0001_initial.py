# Generated by Django 2.1.3 on 2018-12-03 09:39
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[('male', '男'), ('famale', '女')], default='male', max_length=5, verbose_name='性别')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('send_type', models.CharField(choices=[('register', '用户注册'), ('forget', '忘记密码'), ('update_email', '修改邮箱')], max_length=100, verbose_name='验证码类型')),
